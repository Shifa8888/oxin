        ...
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 py-10 grid md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.facebook.com/HashirMikey" target="_blank" rel="noopener noreferrer" title="Facebook" className="h-9 w-9 rounded-lg border grid place-items-center hover:scale-110 transition-transform" style={{ borderColor: t.border }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
              </a>
              <a href="https://www.instagram.com/hashirmikey/" target="_blank" rel="noopener noreferrer" title="Instagram" className="h-9 w-9 rounded-lg border grid place-items-center hover:scale-110 transition-transform" style={{ borderColor: t.border }}>
              ...
              <a href="https://www.tiktok.com/@mikeyxmina676789" target="_blank" rel="noopener noreferrer" title="TikTok" className="h-9 w-9 rounded-lg border grid place-items-center hover:scale-110 transition-transform" style={{ borderColor: t.border }}>
